...
- You think you have discovered a potential security vulnerability in the Prometheus data connector or related components.
- You are unsure how a vulnerability affects the connector.
- You think you discovered a vulnerability in another project that the connector depends on (e.g. Docker, etc).

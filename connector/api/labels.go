...
func FunctionPrometheusLabelNames(
	ctx context.Context,
	...
	results, warnings, err := state.Client.LabelNames(
		ctx,
		args.Match,
		*args.Start,
		*args.End,
...
func FunctionPrometheusLabelValues(
	ctx context.Context,
	state *metadata.State,
	arguments *PrometheusLabelValuesArguments,
) ([]string, error) {
	...
	rawResults, warnings, err := state.Client.LabelValues(
		ctx,
		arguments.LabelName,
		args.Match,
		*args.Start,

...
func FunctionPrometheusTargets(
	ctx context.Context,
	state *metadata.State,
) (v1.TargetsResult, error) {
...
func FunctionPrometheusTargetsMetadata(
	ctx context.Context,
	state *metadata.State,
	arguments *PrometheusTargetsMetadataArguments,
) ([]v1.MetricMetadata, error) {
